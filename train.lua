...
cmd:text('Options')
-- data
cmd:option('-data_dir','data/english','data directory. Should contain the file input.txt with input data')
...
-- optimization
cmd:option('-learning_rate',1.5e-2,'learning rate')
cmd:option('-learning_rate_decay',0.96,'learning rate decay')
...
cmd:option('-seq_length',150,'number of timesteps to unroll for')
